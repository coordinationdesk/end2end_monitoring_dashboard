...
Welcome to `maas-engine` contributor's guide.
...
If you experience bugs or general issues with `maas-engine`, please have a look
...
You can help improve `maas-engine` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`maas-engine` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `maas-engine`'s files. While this mechanism can
...
```
conda create -n maas-engine python=3 six virtualenv pytest pytest-cov
conda activate maas-engine
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/maas-engine.git
   cd maas-engine
   ```
...
5. Install [pre-commit]:
   ...
   `maas-engine` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/maas-engine
[issue tracker]: https://github.com/<USERNAME>/maas-engine/issues
