...
Welcome to `maas-cds` contributor's guide.
...
If you experience bugs or general issues with `maas-cds`, please have a look
...
You can help improve `maas-cds` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`maas-cds` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `maas-cds`'s files. While this mechanism can
...
```
conda create -n maas-cds python=3 six virtualenv pytest pytest-cov
conda activate maas-cds
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/maas-cds.git
   cd maas-cds
   ```
...
5. Install [pre-commit]:
   ...
   `maas-cds` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/maas-cds
[issue tracker]: https://github.com/<USERNAME>/maas-cds/issues
