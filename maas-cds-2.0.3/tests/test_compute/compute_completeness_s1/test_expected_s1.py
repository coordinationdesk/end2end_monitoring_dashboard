...
def test_bug_expected_wrong_value(
    mock_datatake_compute_local_value, mock_find_brother_products_scan
):
    mock_datatake_compute_local_value.side_effect = [
        30580000,
        30580000,
        30580000,
        30580000,
...
def test_evaluate_expected_over_specific_area_ocn(
    ...
    assert global_expected == {"sensing": 2370802000}
