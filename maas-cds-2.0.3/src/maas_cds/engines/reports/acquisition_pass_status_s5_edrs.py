...
from maas_cds.engines.reports.hktm_impact import HktmImpactMixinEngine
...
def get_hash(fields: typing.List[str], input_document: typing.Any):
    """Calculate an hash using the value of different field in an input document

    Args:
        fields (typing.List[str]): field name to use for hash calculation
        input_document (typing.Any): input document containing the fields
    Raises:
...
class AcquisitionPassStatusConsolidatorS5AndEDRS(
    AnomalyImpactMixinEngine, HktmImpactMixinEngine, DataEngine
):
    """
    ...
    ENGINE_ID = ""
    RAW_DATA_TYPE: typing.Any = None
    CONSOLIDATED_DATA_TYPE: typing.Any = None
    ...
    def __init__(
        ...
        self.extra_document_to_consolidate: typing.Dict[typing.Dict[typing.List]] = {}

    def get_consolidated_aps_documents(
        self, consolidated_id_list: typing.List[str]
    ...
    def preprocess_input_documents(
        self, input_documents: typing.List[typing.Any]
    ) -> typing.List[ApsEdrs]:
    ...
    def consolidate_from_raw_data(
        ...
        Args:
            input_document (List[typing.ANY]): raw data to ingest
    ...
    def get_consolidated_id(self, input_document: typing.Any) -> str:
        """Field from raw data input document are used to create a consolidated data identifier.

        Args:
            input_document (typing.Any): Raw Data document
    ...
    def fill_report_name(
        self, report_type: str, report_name: str, consolidated_document: typing.Any
    ):
        ...
        Args:
            ...
            consolidated_document (typing.Any): consolidated document about to be filled

        Returns:
            typing.Any: consolidated document with its report name filled
        """
    ...
    def fill_and_filter_consolidated_document(
        self,
        raw_data_list: typing.List[typing.Any],
        consolidated_documents_dict: typing.Dict[typing.Any, typing.Any],
    ) -> typing.List[typing.Any]:
        ...
        Args:
            raw_data_list (typing.Any): list of raw data to ingest
            consolidated_documents_dict
    ...
    def fill_data(
        self,
        raw_data: typing.Any,
        consolidated_document: typing.Any,
    ) -> typing.Any:
        """Fill a consolidated data using a raw data document.

        Args:
            raw_data (typing.Any): raw data to ingest
            consolidated_document
                    (typing.Any): consolidated documents DAO

        Returns:
            typing.Any:  filled consolidated documents DAO
        """
...
class EDRSAcquisitionPassStatusConsolidatorEngine(
    ...
    def fill_data(
        ...
        self._apply_anomalies(raw_data, key=self.ANOMALY_KEY)
    ...
    def preprocess_input_documents(
        self, input_documents: typing.List[ApsEdrs]
    ) -> typing.List[ApsEdrs]:
        ...
        Args:
            input_documents (typing.List[ApsEdrs]): list of input documents received by the engine

        Returns:
            typing.List[ApsEdrs]: Input ApsEdrs documents with the
    ...
    def postprocess_consolidated_documents(
        self,
        consolidated_document_list: typing.List[CdsEdrsAcquisitionPassStatus],
    ) -> typing.List[CdsEdrsAcquisitionPassStatus]:
        ...
        Returns:
            typing.List[CdsEdrsAcquisitionPassStatus]: list of consolidated documents
        ...
        for doc_link_session_id_dict in self.extra_document_to_consolidate.values():
            ...
            for fictive_input_doct_list in doc_link_session_id_dict.values():
                ...
                sorted(fictive_input_doct_list, key=lambda x: x.report_type)
