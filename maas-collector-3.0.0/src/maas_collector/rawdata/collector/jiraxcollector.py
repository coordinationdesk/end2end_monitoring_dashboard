...
class JiraExtendedCollectorConfiguration(FileCollectorConfiguration):
    ...
    def has_proxy_auth(self) -> bool:
        ...
        """
        return self.proxy_login and self.proxy_password
