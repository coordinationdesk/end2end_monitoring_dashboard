...
def backup_parser():
    ...
    parser.add_argument(
        ...
        "--backup",
        dest="backup_enabled",
        help="Enable SFTP backup (default: %(default)s)",
        action=EnvDefault,
...
def replay_parser() -> ArgumentParser:
    ...
    parser.add_argument(
        "--replay-suffix",
        dest="replay_suffix",
        help="This field allow us to have multiple replay for a single interface_name (default: %(default)s)",
        action=EnvDefault,
...
def common_parser() -> ArgumentParser:
    ...
    parser = ArgumentParser(
        add_help=False,
        parents=[es_parser(), amqp_parser(), backup_parser(), replay_parser()],
    )
